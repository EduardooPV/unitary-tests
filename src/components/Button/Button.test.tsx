...
describe('<Button />', () => {
  ...
  it('should call to function in on click', () => {
    ...
    render(<Button onClick={onClickMock}>Testing</Button>)
  ...
  it('should render button with variant primary', () => {
    render(<Button variant="primary">Testing</Button>)
  ...
  it('should render button with variant secondary', () => {
    render(<Button variant="secondary">Testing</Button>)
  ...
  it('should render button with variant danger', () => {
    render(<Button variant="danger">Testing</Button>)
  ...
  it('should render button with size small', () => {
    render(<Button size="small">Testing</Button>)
  ...
  it('should render button with size medium', () => {
    render(<Button size="medium">Testing</Button>)
